...
public class IdentifyElementForRefacrotingDialog extends DialogWrapper {

	private JPanel myMainPane;
	private JTextArea codeTextArea;

	public IdentifyElementForRefacrotingDialog(@Nullable Project project, boolean canBeParent) {
