...
/**
 * Utility class for managing localized messages in the inspection plugin for dialogues.
 * <p>
 ...
 * </p>
 */
public final class DialoguesBundle extends DynamicBundle {

	private static final DialoguesBundle CURRENT_INSTANCE = new DialoguesBundle();

	@NonNls
	public static final String BUNDLE = "messages.dialogue";

	private DialoguesBundle() {
		super(BUNDLE);
	}
